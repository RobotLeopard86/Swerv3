...
import frc.robot.Constants.Mk4iReductions;
import frc.robot.Constants.Mk5nReductions;
...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs().withKP(20).withKI(0).withKD(0).withKS(2.00544)
            .withKV(1.05710).withKA(0);
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.85216);
    ...
    private static final double kSteerGearRatio = Mk4iReductions.TURN.reduction;
    ...
    private static final MomentOfInertia kSteerInertia = KilogramSquareMeters.of(0.0004);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.201416015625);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.418701171875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.4169921875);
